...
//     const videoLoading = videoLoadingRef.current;
...
//       if (videoContainer) {
//         videoContainer.style.background = "linear-gradient(135deg, #4b6cb7, #182848)";
//       }
//     };
...
//       <div className="video-loading" id="video-loading" ref={videoLoadingRef}>
